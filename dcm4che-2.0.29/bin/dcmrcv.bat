...
rem $Id: dcmrcv.bat 18015 2013-08-27 12:03:33Z gunterze $

if not "%ECHO%" == ""  echo %ECHO%
if "%OS%" == "Windows_NT"  setlocal

set MAIN_CLASS=org.dcm4che2.tool.dcmrcv.DcmRcv
set MAIN_JAR=dcm4che-tool-dcmrcv-2.0.29.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-filecache-2.0.29.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-2.0.29.jar
